...
Thank you Dr. Köhler and Alex for your invaluable trust and guidance
#+latex: \end{center}
#+latex: \vspace*{\fill}
\clearpage
...
Double-Talk or Overlapping Speech that occurs in normal conversations, where
participants speak simultaneously for brief durations of time during some
characteristic situations. On the other hand, this phenomenon is a nuisance to
various speech technologies where it contributes as a major source of errors in
their otherwise state of the art performances. Automatically detecting and
temporally localizing these double-talk situations in audios of conversations,
to be either directly useful to the former, or as a starting point for
appropriate handling for the latter, is, therefore, the ultimate goal of this
thesis.

Knowing that achieving this goal has proven to be extremely challenging with
classic approaches, a Deep Convolutional Neural Networks based .
Various approaches for tackling the expected hurdles in such an
exploration are scientifically evaluated.
